...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
    ...
    echo "Error in patient registration: " . mysqli_error($con);
}

// Retrieving and setting session variable for patient ID
    ...
    if($result1){
      ...
      echo "Error retrieving patient ID: " . mysqli_error($con);
  }
