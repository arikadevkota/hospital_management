...
<body style="padding-top:50px;">
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
      ...
      <?php
// Check if the billing functionality is being accessed
if ($feature == 'billing') {
    // Display a message that billing is not available
    echo "<p>Billing: Not Available</p>";
} else {
    // Any other code for different features or functionalities
}
?>
